...
namespace Models
{
    internal static class DatabaseContextInitializer
    {
        ...
        {
            InsertRole("f1dcedb2-a865-4c73-bc51-1afd28118d39", "Company", "شرکت پیمانکار", databaseContext);
            InsertRole("f53d469b-4172-42a9-8355-20032367c627", "Administrator", "راهبر", databaseContext);
            InsertRole("b999eb27-7330-4062-b81f-62b3d1935885", "Supervisor", "ناظر", databaseContext);
        }
